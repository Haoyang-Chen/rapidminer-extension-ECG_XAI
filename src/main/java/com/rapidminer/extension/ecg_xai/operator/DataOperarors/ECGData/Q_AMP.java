...
public class Q_AMP extends Operator {
    private final OutputPort DataOutput = getOutputPorts().createPort("Q_AMP Q wave amplitude");

    public Q_AMP(OperatorDescription description) {
        super(description);
    }

    @Override
    public void doWork() throws OperatorException {
        String name="Q_AMP Q wave amplitude";
